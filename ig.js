...
const URI =
  "mongodb+srv://nero:5D78B9EE1B@cluster0.ptxzp.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
mongoose.connect(URI || "mongodb://localhost/ig_db", {
  useNewUrlParser: true,
  useUnifiedTopology: true,
}); //  process.env.IG_DATABASE  ||
